            	...
            	<div class="table">
                	<table>
                    	<tr>
                                    ...
                                    <?php
                                    $pagesize = 10; //设置每页记录数
                                    $sql = "SELECT * FROM `mail` WHERE uid=".$_SESSION['ID']." and issdelete=0 ".$_SESSION['Search']." ".$_SESSION['SearchType']."";
                                    ...
                                    $sql = "SELECT * FROM `mail` WHERE uid=".$_SESSION['ID']." and issdelete=0 ".$_SESSION['Search']." ".$_SESSION['SearchType']." order by fdate desc limit ".$start.",".$pagesize;
                                    if($query = mysql_query($sql)){
