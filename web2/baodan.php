...
<!--        	<ul class="list1 clearfix">
        	...
        	?>
            	<li class="<?=$kaiguan1?>"><a href="baodan.php?cc=9&kg=1">默认</a></li>
            	<li class="<?=$kaiguan2?>"><a href="baodan.php?cc=2&kg=2">价格</a></li>
            	<li class="<?=$kaiguan3?>"><a href="baodan.php?cc=1&kg=3">人气</a></li>
            <li class="<?=$kaiguan4?>"><a href="baodan.php?cc=3&kg=4">库存</a></li>
...
//                    		}
                    		$pagesize = 20; //设置每页记录数
                    		$sql = "SELECT * FROM `goods` where lx=1" ;
         			 ...
         			 <tr>
                    	<td>
                        	<a href="show.php?goodid=<?=$row['id']?>">
                                <img src="<?=$img?>" alt=""/>
								<h3><?=$row['goodsname']?></h3>
                                    <p><strong style="color:#0084EB; font-size:18px;">
