...
if ($_POST['submit']){
    ...
    $res = getOne("SELECT * FROM member where id=$uid");
      ...
      if(md5($_POST['password2'])==$member['password2']){
            ...
            edit_sql("update `member` set qckai=1 where  id={$uid}");
...
<div id="container">
  ...
  <header id="gHeader"> 
    	...
    	<ul class="list2 list1 clearfix">
            	<li class="on"><a href="wytuiguang.php">推广申请</a></li>
            	<!--  
            ...
            <form action="" method="post">
                <div class="table3">
                    ...
                    <?php if($member['qckai']==0){?>	
                    	...
                    	<li>
                              <input type='text' value="已提交推广申请!"   style="background:#eee;color:black;" readonly/>
