...
<div class="mainBox">
        ...
        <input type="submit" name="Search" id="Search" class="btn1" value="搜索">
                ...
                <div class="table">
                	...
                	<table>
						...
						<?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `buysell` WHERE isgrant=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']."";
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `buysell` WHERE isgrant=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']." order by cdate desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
