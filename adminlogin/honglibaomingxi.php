                ...
                <div class="table">
                	...
                	<table>
                    	<tr>
						 ...
						 <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `honglibao` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']." $a $b ";
	  //	print_r($sql);
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	...
      	$sql = "SELECT * FROM `honglibao` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']." $a $b order by bdate desc,id desc limit ".$start.",".$pagesize;
