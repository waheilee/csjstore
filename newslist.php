...
$ul=ulevel($us['ulevel']);
?>
<!-- saved from url=(0042)http://hengxingbi.cn/index.php/Index/index -->
...
<meta charset="utf-8">
    ...
    <!--[if lt IE 9]><script language="javascript" type="text/javascript" src="/Public/images/excanvas.js"></script><![endif]-->
    <script class="include" type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
